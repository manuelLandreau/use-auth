...
export default function useAuth(): {
    login: <T, U>(data: T, url: string, remember?: boolean, tokenKey?: string, storageKey?: string) => Promise<AxiosResponse<U, any>>;
    register: <T_1, U_1>(data: T_1, url: string) => Promise<AxiosResponse<U_1, any>>;
    refresh: <T_2>(url: any, tokenKey?: string, storageKey?: string) => Promise<AxiosResponse<T_2, any>>;
