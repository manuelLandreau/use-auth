...
export default function useAuth() {
     ...
     */
    function login(data, url, remember, tokenKey, storageKey) {
        if (remember === void 0) { remember = false; }
        if (tokenKey === void 0) { tokenKey = 'token'; }
        if (storageKey === void 0) { storageKey = 'jwt'; }
     ...
     */
    function refresh(url, tokenKey, storageKey) {
        if (tokenKey === void 0) { tokenKey = 'token'; }
        if (storageKey === void 0) { storageKey = 'jwt'; }
        isLoading.value = true;
        error.value = null;
        ...
        if (localStorage.getItem(storageKey)) {
            ...
            axios.defaults.headers.common['Authorization'] = sessionStorage.getItem(storageKey);
